...
/**
 * Provides the 'PayPal Donation' configuration form.
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'paypal_donation_configure_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['amount_label'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Amount label text'),
      '#default_value' => $config->get('amount_label'),
    ];
    ...
    $form['custom_container'] = [
      '#type' => 'details',
      '#title' => $this->t('Custom amount settings'),
      '#open' => TRUE,
      '#states' =>  [
        'visible' => [
    ...
    $form['custom_container']['custom_max'] = [
      '#type' => 'number',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config
      ...
      ->set('amount_label', $form_state->getValue('amount_label'))
